...
public sealed class Lexer
{
    private static readonly Dictionary<string, TokenKind> Keywords = new(StringComparer.Ordinal)
    {
        ...
        ["line-set"] = TokenKind.LineSet,
        ["line-set-rel"] = TokenKind.LineSetRel,
        ["rect"] = TokenKind.Rect,
        ["rect-outline"] = TokenKind.RectOutline,
        ["rect-set"] = TokenKind.RectSet,
        ["rect-set-outline"] = TokenKind.RectSetOutline,
        ["arc"] = TokenKind.Arc,
        ["arc-outline"] = TokenKind.ArcOutline,
        ["arc-set"] = TokenKind.ArcSet,
        ["arc-set-outline"] = TokenKind.ArcSetOutline,
        ["polygon"] = TokenKind.Polygon,
        ["polygon-outline"] = TokenKind.PolyOutline,
        ["polygon-set"] = TokenKind.PolySet,
        ["polygon-set-outline"] = TokenKind.PolySetOutline,
        ["poly"] = TokenKind.Polygon,
        ["poly-outline"] = TokenKind.PolyOutline,
        ["poly-set"] = TokenKind.PolySet,
        ["poly-set-outline"] = TokenKind.PolySetOutline,
