...
public class SetColorCommandTests
{
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x64, 0x64, 0x64]));
    ...
    public void TestRed()
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x52, 0x52, 0x52]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x49, 0x49, 0x49]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x76, 0x76, 0x76]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x50, 0x60, 0x56]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x7F, 0x7F, 0x7F]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x40, 0x40, 0x40]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x49]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x52]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x6D]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x7F]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x40]));
    ...
    {
        var command = new SetColorCommand(new(), 0xBC, new NaplpsOperands([0x76]));
