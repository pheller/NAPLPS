...
[TestClass]
public class LineRelativeCommandTests
{
    [TestMethod]
    public void Defaults()
    {
        var lineRelativeCommand = new LineRelativeCommand(new(), 0xA9, new NaplpsOperands([]));

        Assert.IsNotNull(lineRelativeCommand);
    ...
    [TestMethod]
    public void ByteMagazineMarch1983Page161First()
    {
        var lineRelativeCommand = new LineRelativeCommand(new(), 0xA9, new NaplpsOperands([0x7F, 0x75, 0x74]));
