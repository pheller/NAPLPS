...
public class RectangleFilledCommandTests
{
    ...
    {
        var rectangleFilledCommand = new RectangleFilledCommand(new(), 0xB1, new NaplpsOperands([]));
    ...
    {
        var rectangleFilledCommand = new RectangleFilledCommand(new(), 0xB1, new NaplpsOperands([0x40, 0x7C, 0x40]));
