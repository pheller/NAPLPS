...
public class RectangleSetFilledCommandTests
{
    ...
    {
        var rectangleSetFilledCommand = new RectangleSetFilledCommand(new(), 0xB3, new NaplpsOperands([]));
    ...
    public void Zero()
    {
        var rectangleSetFilledCommand = new RectangleSetFilledCommand(new(), 0xB3, new NaplpsOperands([0x40, 0x40, 0x40, 0x40, 0x40, 0x40]));
    ...
    public void NegativeDimensions()
    {
        ...
        var rectangleSetFilledCommand = new RectangleSetFilledCommand(state, 0xB3, new NaplpsOperands([0x4A, 0x65, 0x45, 0x45, 0x47, 0x45, 0x5B, 0x66]));
